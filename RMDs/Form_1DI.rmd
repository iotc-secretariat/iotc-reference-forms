...
You can download the recommended form for submitting the dataset for the 2023 statistical year [here](../forms/legacy/Form-1DI-legacy.xlsx).

Please help us by using the new forms on an optional basis and providing feedback. Click [here](../forms/Form-1DI.xlsx) to download an empty version of Form 1DI, or [return](../forms) to the list of all new versions of the IOTC statistical data reporting forms.
