...
In order to ensure a smooth transition between the historical data reporting process (which used macro-enabled, self validating Microsoft Excel spreadsheets) and the [newly proposed IOTC forms](https://iotc.org/documents/WPDCS/19/14), a version of the most common forms has been designed that presents the new form structure while maintaining references to the fishery and target species codes used by the previous IOTC forms.
