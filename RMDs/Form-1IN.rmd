...
| Reporting entity | M | Entity reporting the data to the IOTC Secretariat | **Code** from [Entities](#entities) |
| Flag state | M | Country of registration of the fishing vessels | **Code** from [Countries](#countries) |
