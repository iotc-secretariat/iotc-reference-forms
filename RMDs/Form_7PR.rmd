...
Click [here](../forms/legacy/Form-7PR-legacy.xlsm) to download an empty version of the legacy form 7-PR, or [return](../forms) to the list of all versions of the IOTC statistical data reporting forms. 
