...
| [Reporting entity]{#repentity} |      M      | **Code** of the entity reporting the dataset to the IOTC Secretariat           |  **Code** from [Entity](#countries) codelist   |
| [Flag state]{#repflagstate}    |      M      | **Code** of the country registration of the fishery vessels                    | **Code** from [Countries](#countries) codelist |
...
| Fishery       |      M      | IOTC-defined fisheries                 | **Code** from [Fisheries](#fisheries) codelist                                 |
| IOTC area     |      M      | Main IOTC areas                        | **Code** from [IOTC main areas](#IOTCareasMain) codelist                       |
...
|:-----------------|:-------------:|:------------------------|:--------------|
| Original data type       |      M      | Preliminary/final status of the data | **Code** from [Type of data](#types) codelist                                  |
| Original data source     |      M      | Source of information                | **Code** from [Retained catches data sources](#dataSourcesRC) codelist         |
| Original data processing |      M      | Processing applied to the data       | **Code** from [Retained catches data processings](#dataProcessingsRC) codelist |
| Source coverage type     |      M      | Variable used for data coverage      | **Code** from [Coverage types](#coverageTypes) codelist                        |
