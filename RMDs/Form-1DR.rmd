...
For the combination of each taxon, gear group, and fishery category listed in the form, the cell must be filled with either a value of one (1) in case of positive catch or a value of zero (0) in case of absence of catch, i.e., no landing nor discard.
