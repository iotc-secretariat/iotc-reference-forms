...
| Element | Requirement | Description | Input value  |
| :----------------- | :-----: | :----------------------- | :-------: |
| Vessel type | M | | **Code** from [](#vesselTypes) |
...
| Element | Requirement | Description | Input value  |
| :----------------- | :-----: | :----------------------- | :-------: |
| Architecture | M | Classification of the fishing vessels based on structural design and construction type | **Code** from [Vessel architectures](#vesselArchitectures) |
