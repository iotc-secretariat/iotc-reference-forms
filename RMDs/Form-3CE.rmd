...
Click [here](../forms/Form-3CE.xlsx) to download a blank version of Form 3-CE, or [return](../forms) to the list of all new versions of the IOTC statistical data reporting forms. The form allows reporting updated data for multiple fisheries simultaneously. Click [here](../forms/Form-3CE-update.xlsx) to download a blank version of Form 3-CE which has been designed to report updated data for a single fishery.
