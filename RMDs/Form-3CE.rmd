...
This form supports the reporting of estimates of species-specific catches and efforts by fishing fleet, fishery, and space and time strata for a given CPC / fleet, _as initial submission for all fisheries of a CPC in June_.

Click [here](../forms/Form-3CE.xlsx) to download a blank version of Form 3-CE, or [return](../forms) to the list of all new versions of the IOTC statistical data reporting forms.
...
| Grid | M | The 7-digit CWP grid square of the fishing area in the Indian Ocean  | **Code** from [IOTC Grids](https://data.iotc.org/reference/latest/domain/admin/#IOTCgridsCESF) or [IOTC artisanal grids](https://data.iotc.org/reference/latest/domain/admin/#FAOareas) |
