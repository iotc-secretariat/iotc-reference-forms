...
|:--------------------|:--------------------|
|Plastic (_state if plastic materials are present_)  |Plastic (_state if plastic materials are present_)|
|Metal (_state if metal materials are present_) | Metal (_state if metal materials are present_) |
|Length | Length |
|Width | Width |
|Height |Height |
|Mesh? (_state if mesh are present_) |Mesh? (_state if mesh are present_) |
|Mesh size  | Mesh size |
