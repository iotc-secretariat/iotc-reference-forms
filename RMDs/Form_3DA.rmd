...
This form supports the reporting of _Operational activities conducted by purse seine and support vessels on DFOBs and buoys, **annually**_.
...
Click [here](https://data.iotc.org/reference/latest/forms/Form-3DA.xlsx) to download an empty version of form 3-DA, or [return back](..) to the list of all IOTC statistical data reporting forms.
