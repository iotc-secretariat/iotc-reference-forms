...
Click [here](../forms/Form-3DA.xlsx) to download an empty version of form 3-DA, or [return back](../forms) to the list of all IOTC statistical data reporting forms.
...
| [Reporting entity]{#repentity} | M | Entity reporting the dataset to the IOTC Secretariat | **Code** from [Entity](#countries) |
| [Flag state]{#repflagstate} | M | Country registration of the fishery vessels | **Code** from [Countries](#countries) |
...
| :----------------- | :-----: | :----------------------- | :-------: |
| Identifier | M | FOB identification (Deacon ID) | Plain text      |
| Type| M | Type of FOBs  | **Code** from [dFOB types](#FOBtypes) |
| Activity    | M | Type of activities undertaken when visiting or deploying  FOB | **code** [dFOB activity types](#FOBactivityTypes) |
