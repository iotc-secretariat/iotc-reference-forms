---
title: "IOTC statistical data reporting: Legacy Form 4SF (v`r BASE_VERSION`)"
...
Length frequency is defined as the number of individuals of a catch or catch sample in each length interval ([UN ESCWA](https://www.unescwa.org/sd-glossary/length-frequency-distribution-lfd)). The modal size is the length group with the higher number of individuals.
...
Click [here](../forms/legacy/Form-4SF-legacy.xlsm) to download a blank version of Form 4-SF, or [return](../forms) to the list of all IOTC statistical data reporting forms.
