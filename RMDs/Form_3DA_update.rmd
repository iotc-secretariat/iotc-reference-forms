...
Click [here](../forms/Form-3DA-update.xlsx) to download an empty version of form 3-DA-update, or [return](../forms) to the list of all new versions of the IOTC statistical data reporting forms.
