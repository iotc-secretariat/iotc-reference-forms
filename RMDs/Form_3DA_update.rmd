...
Indicate if any of the components are found, and size of the dFOB. 
...
<div class="component">
|Surface (raft) | Subsurface (tail)|Description | Format |
|:--------------------|:--------------------|:--------------------|:--------------------|
|Plastic  |Plastic | Indicate if the dFOB contains plastic material| Boolean|
|Metal  | Metal  | Indicate if the dFOB contains metal material| Boolean|
|Length | Length | Length of dFOB| Decimal(cm) |
|Width | Width | Width of dFOB| Decimal(cm) |
|Height |Height |Height of dFOB|Decimal(cm)|
|Mesh |Mesh | Indicate if the dFOB contains mesh| Boolean|
|Mesh size  | Mesh size |Size of the mesh| Decimal(mm)|
