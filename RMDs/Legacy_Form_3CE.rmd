---
title: "IOTC statistical data reporting: Legacy Form 3CE (v`r BASE_VERSION`)"
...
o   	Purse seine and pole-and-line fisheries: catch weight by species and fishing effort by fishing mode, 1° grid area and month strata. In addition:
Support vessels: effort data expressed as the number of days at sea by 1° grid area and month.
Fish Aggregating Devices (FAD): effort data expressed as the total number of FAD visited per type of FAD, type of visit, 1° grid area and month.
o   	Other fisheries: catch weight by species and fishing effort by 1° grid area and month strata.
...
Catch-and-effort data shall be extrapolated (raised) to the total catches (and effort) for the fishery concerned. 


Click [here](../forms/legacy/Form-3CE-legacy.xlsm) to download a blank version of Form 3-CE, or [return](..) to the list of all new versions of the IOTC statistical data reporting forms.
...
| Target species    |      M      | Species targeting by the fishery      |  **Code** from [Species](#LegacySPECIES) |
...
a.	5 to refer to 1° square areas (catch-and-effort surface fleets and support vessels)
b.	6 to refer to 5° square areas (catch-and-effort longline fleets and size data all fleets)
...
In the Indian Ocean, only 1 and 2 will apply	 
