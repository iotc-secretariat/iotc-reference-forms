...
Click [here](https://data.iotc.org/reference/latest/forms/Form-1IN.xlsx) to download an empty version of form 1-IN, or [return back](../forms) to the list of all IOTC statistical data reporting forms.
...
| [IOTC main areas]{#IOareasMain}| M | Main IOTC areas of competence | **Code** from [IOTC main areas](#IOareasMain) |

## Orignal data

| Element | Requirement | Description | Input value |
| :----------------- | :-----: | :----------------------- | :-------: |
| Original data type | M | Preliminary/final status of the data | **Code** from [Type of data](../domain/data/#types) |
| Types of Coverage   | M | Variable used for data coverage | **Code** from [Types of Coverage](#coverageTypes) |
