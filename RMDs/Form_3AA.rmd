...
Click [here](https://data.iotc.org/reference/latest/forms/Form-3AA.xlsx) to download an empty version of form 3-AA, or [return](../forms) to the list of all new versions of the IOTC statistical data reporting forms.
...
| Type | M | Type of floating objects | **Code** from [AFOB types](#FOBtypes) |
| Activity | M | Type of activities undertaken when visiting or deploying a floating object | **Code** from [AFOB activity types](#FOBactivityTypes) |
...
## Types of anchored fishing object (aFOB) {#FOBtypes}
...
## Types of anchored fishing activity types {#FOBactivityTypes}
