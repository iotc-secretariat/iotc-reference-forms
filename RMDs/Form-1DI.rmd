...
Number or live weight of discards by species, including their condition at release, if the data is raised, along with information on the value (%) and type of sampling coverage used for the estimations by  quarter if available, year, fleet, fishery, and IOTC main area.
...
### Discarded catches data processings {#dataProcessingsDI}
