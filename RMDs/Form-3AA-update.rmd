...
Click [here](../forms/Form-3AA-update.xlsx) to download a blank version of Form 3-AA-update, or [return](../forms) to the list of all IOTC statistical data reporting forms. The form allows reporting updated data for a single fishery. Click [here](../forms/Form-3AA.xlsx) to download a blank version of Form 3-AA which has been designed to report data for multiple fisheries simultaneously.
