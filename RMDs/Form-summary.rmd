...
You can download all form templates for submitting the data for the statistical year 2024 [here](../forms/IOTC-forms.zip). We welcome your feedback on these new forms and encourage you to direct any questions to the IOTC Secretariat via email at [IOTC-Statistics@fao.org](mailto:IOTC-Statistics@fao.org).
