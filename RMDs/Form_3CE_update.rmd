...
| Original data source     | M | Source of information | **Code** of the [catch and effort data sources](#sourcesCE)          |
...
|Grid| M | the seven digits grid square of the fishing area in Indian Ocean   |**Code** of the  [Grid codes](#IOTCgridsCESF) |
...
| Element        | Requirement | Description | Input value  |
| :------------- | :-----: | :----------------------- | :-----------: |
| Estimation   | M | Indicate if the data was estimated or actual recorded data |**Code** of the [Estimations](#estimations)     |
