...
Length frequency is defined as The number of individuals of a catch or catch sample in each length interval. The modal size is the length group with the higher number of individuals by [UN ESCWA](https://www.unescwa.org/sd-glossary/length-frequency-distribution-lfd). 
