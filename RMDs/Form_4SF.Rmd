...
| Element        | Requirement | Description | Code list  |
| :----------------- | :-----: | :----------------------- | :-------: |
| Size class (_lo_)  | M | The lowest size recorded for the sample | integer    |
| Size class (_hi_)  | M | The highest size recorded for the sample | integer    |
...
### Measurement type (MOR.MTY) {#typesOfMeasurement}
...
### Measurement types (MOR.MES)) {#Measurement}
