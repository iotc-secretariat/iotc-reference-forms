...
Click [here](https://data.iotc.org/reference/latest/forms/Form-2FC.xlsx) to download an empty version of form 1-RC, or [return back](../forms) to the list of all IOTC statistical data reporting forms.
...
| Original data source     | M | Source of information | [Fishing craft data sources](#sourcesFC)          |
| Original data processing | M | Processing applied to the data    | [Fishing craft data processings](#dataProcessingsFC) |
...
| Element        | Requirement | Description | Code list  |
| :----------------- | :-----: | :----------------------- | :-------: |
| Boat type     | M | Fishing boat classification based on shape and purpose| [boat type](#boatTypes)      |
| Mechanisation type    | M | Type of boat mechanization| [Mechanisation type](#mechanizationTypes)          |
| Boat class types | M |  Vessel size categories  | [Boat class types](#boatClassTypes) |
| [Fish preservation method](#fishPreservationMethods)   | M | Type of preservation methods being used for target species onboard boats | [Fish preservation method](#fishPreservationMethods) |
| Fish storage   | M | Type of structures present on-board and used by the vessel to store the catch | [Fish storage method](#fishStorageTypes) |
...
### Fish storage types (VES.PR) {#fishStorageTypes}
