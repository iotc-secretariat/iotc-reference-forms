...
Click [here](https://data.iotc.org/reference/latest/forms/Form-2FC.xlsx) to download an empty version of form 1-RC, or [return back](..) to the list of all IOTC statistical data reporting forms.
