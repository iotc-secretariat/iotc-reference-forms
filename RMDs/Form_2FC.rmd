...
Click [here](../latest/forms/Form-2FC.xlsx) to download an empty version of form 1-RC, or [return back](../forms) to the list of all IOTC statistical data reporting forms.
...
| Element        | Requirement | Description | Inpput value  |
| :----------------- | :-----: | :----------------------- | :-------: |
