...
This form support the reporting of *total numbers of boats/ fishing vessel involved in fishing activities*. The term fishing vessel is used when the vessel is engaged only in catching operations [CWP](The measure of effort (unit of fishing effort). IOTC classification of fishery vessels by fishery types relate to [FAO ISSCFV code](https://www.fao.org/3/cb5201en/cb5201en.pdf). 
