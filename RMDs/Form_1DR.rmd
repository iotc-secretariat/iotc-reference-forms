...
### Gear groups (FIS.GG) {#gear_groups}

Reference codes modelling the gear groups by which the matrix table is assessing for the reporting catch by species.
...
Reference codes modelling the species by which the matrix table is assessing for the reporting catch by gear groups.
